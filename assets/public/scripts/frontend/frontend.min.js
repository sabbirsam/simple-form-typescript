...
function generateRenderedForm(formData) {
  ...
  formData.forEach(function (field) {
    switch (field.type) {
      ...
      case 'email':
      case 'hidden':
        html += "\n          <div class=\"text-fields\">\n            <label for=\"".concat(field.id, "\">").concat(field.label, "</label>\n            <input id=\"").concat(field.id, "\" type=\"").concat(field.type, "\" name=\"").concat(field.id, "\" placeholder=\"").concat(field.placeholder, "\" class=\"").concat(field.className, "\" value=\"").concat(field.value || '', "\">\n          </div>\n          <br>\n        ");
        break;
      case 'select':
        html += "\n          <div class=\"text-fields\">\n            <label for=\"".concat(field.id, "\">").concat(field.label, "</label>\n            <select id=\"").concat(field.id, "\" name=\"").concat(field.id, "\">");
        ...
        break;
      case 'file':
        html += "\n          <div class=\"text-fields\">\n            <label for=\"".concat(field.id, "\">").concat(field.label, "</label>\n            <input id=\"").concat(field.id, "\" type=\"").concat(field.type, "\" name=\"").concat(field.id, "\" class=\"").concat(field.className, "\">\n          </div>\n          <br>\n        ");
        break;
      case 'checkbox':
